	...
	initialize: function(){
		...
		var validationFuncs = {
			...
			"numberWeek": function(q) {if(q && (isNaN(q.split(" : ")[1]) || q.split(" : ")[1] == "")) return "Value must be a number";},
    			"oceanEnter": function(q, at) {if(q && at.q25 && _.all(q.split(",").map(function(x) {return at.q25.split(",").indexOf(x) > -1;})))return "Please only select days in which you did not enter the ocean";},
