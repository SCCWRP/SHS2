var LoginView = Backbone.View.extend({
	...
	render: function(){
		...
		$("#back").hide();
		$("#forward").hide();
                $("#header").append("<div id='waiting'>Retrieving...</div>");
                $("#waiting").hide();
                $(document).on({
